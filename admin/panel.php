...
$conteos = [];
foreach (['productos' => 'Productos', 'usuarios' => 'Usuarios', 'ventas' => 'Ventas'] as $tabla => $etiqueta) { $conteos[$etiqueta] = (int)$conexion->query("SELECT COUNT(*) total FROM $tabla")->fetch_assoc()['total']; }
